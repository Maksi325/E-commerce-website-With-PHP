        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-4 col-sm-6">
                    <br>
                    <article class="" style="margin-bottom: 3rem; height: 57rem; background-color:  white; border-radius:20px; ">
                        <br>
                        ...
                        <p style="margin-top: 2rem; margin-left: 11%; margin-right: 11%; width: 78%;">
                            <?php echo $post_content    ?> <a href="post.php?p_id=<?php echo $post_id  ?>">...</a>
                        </p>
